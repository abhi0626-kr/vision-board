...
export function WishCard({ wish, onToggle }: WishCardProps) {
  ...
  return (
    <article className="masonry-item">
      <div 
        className={`group relative overflow-hidden rounded-lg p-5 hover-lift transition-all duration-300 cursor-pointer border ${
          isCompleted 
      ...
      >
        ...
        {isCompleted && (
          <Sparkles className="absolute top-3 right-3 h-5 w-5 text-gold animate-pulse" />
        )}
